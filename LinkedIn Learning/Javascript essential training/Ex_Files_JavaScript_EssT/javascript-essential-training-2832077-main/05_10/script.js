...
//Creating navbar
const listElements = ["home", "contact", "about us", "products", "sales"];
...
newNav.appendChild(unorderList);
// Adding style to navbar
newNav.style.display = "flex";

// Adding navbar after header
const header = document.querySelector("header");
header.insertAdjacentElement("afterend", newNav);
